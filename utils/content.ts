...
export const copy = {
    ...
    text2: 'The number of possible Token Garden NFTs with 100+ rings is set by existing on-chain data instead of by an artificial limit.',
    heading3: 'Earned',
