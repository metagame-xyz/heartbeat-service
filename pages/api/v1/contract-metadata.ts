...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    const metadata = {
        name: copy.title,
        description: `${copy.heroSubheading}. <br><br> Part of **The Metagame**. Follow along on twitter [@The_Metagame](https://twitter.com/the_metagame). Mint one at [birthblock.art](https://www.birthblock.art) `,
